...
C'est exactement le pattern **thunk poussé à l'extrême**. Tu construis une description de programme, puis tu décides quand/comment l'évaluer. Cf. → [[Concept - Un thunk est une fonction qui retarde l'évaluation]].
