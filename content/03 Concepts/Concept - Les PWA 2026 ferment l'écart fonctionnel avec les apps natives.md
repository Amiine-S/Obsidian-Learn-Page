...
**1. Système de fichiers** : sans doute le plus gros saut. Avant, tu étais sandboxé. Maintenant, **VS Code Web édite vraiment ton code local**. → [[Concept - File System Access API donne aux PWA un vrai accès aux fichiers locaux]]
...
**4. Window Controls Overlay** : l'esthétique. Une PWA installée en 2026 peut **ressembler** à une app native, ce qui réduit la perception "page web déguisée". → [[Concept - Window Controls Overlay donne aux PWA desktop le contrôle de la barre de titre]]
