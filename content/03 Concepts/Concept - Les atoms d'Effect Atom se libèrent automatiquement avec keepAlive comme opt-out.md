...
**Concepts liés** :
- [[Concept - Effect Atom unifie state client serveur et DI dans des atomes basés sur Effect]] *(le contexte global)*
- [[Concept - L'ownership de Rust remplace garbage collector et malloc-free]] *(même intuition : ressources libérées à la fin du scope, vérifié par le système — Rust à la compil, Effect à la runtime via scopes)*
- [[Concept - Une closure capture son environnement lexical à la création]] *(les closures Atom capturent — Effect Atom gère leur libération via scopes)*
