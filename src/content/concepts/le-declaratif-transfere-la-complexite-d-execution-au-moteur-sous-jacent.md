---
created: '2026-04-26T15:45:34.941Z'
domain: architecture
level: intermediate
tags:
  - type/concept
  ...
  - level/intermediate
title: >-
  Concept - Le déclaratif transfère la complexité d'exécution au moteur
  sous-jacent
slug: le-declaratif-transfere-la-complexite-d-execution-au-moteur-sous-jacent
excerpt: >-
  C'est le piège classique du déclaratif "naïf" : on imagine qu'écrire en haut
  niveau supprime les considérations de perf, d'allocation, de scheduling. **Ce
  n'est pas vrai.** Quelque part, **quelqu'un** doit décider comment exécuter
  ton intent. En déclaratif, ce quelqu'un est le mo
oneLiner: >-
  Programmer en déclaratif ne fait pas disparaître la complexité de l'exécution
  — ça **la déplace** vers le moteur (compilateur, runtime, query planner) —
  donc plus le moteur est puissant, plus le déclaratif est utilisable, et plus
  son **abstraction peut fuir** quand le moteur prend de mauvaises décisions.
related:
